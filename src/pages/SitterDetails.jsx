    ...
    <div className="max-w-4xl mx-auto p-4 bg-white shadow-lg rounded-lg">
      ...
      <div className="mt-6 space-y-4">
        <button
          ...
          className="w-full bg-indigo-500 text-white py-2 rounded-md hover:bg-blue-500 focus:outline-none"
        >
          Book Services Here
        </button>
        <div className="mt-4"></div>
        <Link to={`/messages/${id}`}>
          <button className="w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-500 focus:outline-none">
            Contact us here
          </button>
        </Link>
      </div>
